namespace Xilium.CefGlue
{
    ...
    public static unsafe class CefRuntime
    {
        ...
        public static void Initialize(CefMainArgs args, CefSettings settings, CefApp application, IntPtr windowsSandboxInfo)
        {
            ...
            try
            {
                var a = libcef.initialize(n_main_args, n_settings, n_app, (void*)windowsSandboxInfo);
                if (/*libcef.initialize(n_main_args, n_settings, n_app, (void*)windowsSandboxInfo)*/a != 0)
                {
                    _initialized = true;
                }
                else
