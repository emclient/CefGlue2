...
namespace Xilium.CefGlue.Interop
{
    ...
    internal struct cef_window_info_t
    {
        internal unsafe static void Free(cef_window_info_t* ptr)
        {
            if (OperatingSystem.IsWindows())
                cef_window_info_t_windows.Free((cef_window_info_t_windows*)ptr);
            else if (OperatingSystem.IsMacOS())
                cef_window_info_t_mac.Free((cef_window_info_t_mac*)ptr);
            else
                cef_window_info_t_linux.Free((cef_window_info_t_linux*)ptr);
        }
    }
    ...
    internal unsafe struct cef_window_info_t_linux
    {
        ...
        {
            var ptr = (cef_window_info_t_linux*)NativeMemory.AllocZeroed((nuint)_sizeof);
