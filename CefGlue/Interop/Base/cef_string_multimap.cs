namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_string_multimap
    {
        ...
        public static NameValueCollection ToNameValueCollectionAndFree(cef_string_multimap* multimap)
        {
            var result = ToNameValueCollection(multimap);
            libcef.string_multimap_free(multimap);
            return result;
        }
