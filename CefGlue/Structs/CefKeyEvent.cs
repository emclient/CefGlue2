...
namespace Xilium.CefGlue
{
    ...
    public sealed class CefKeyEvent
    {
        ...
        internal unsafe cef_key_event_t ToNative()
        {
            return new cef_key_event_t
            {
                size = (UIntPtr)cef_key_event_t.Size,
                type = EventType,
                modifiers = Modifiers,
                windows_key_code = WindowsKeyCode,
                native_key_code = NativeKeyCode,
                is_system_key = IsSystemKey ? 1 : 0,
                character = Character,
                unmodified_character = UnmodifiedCharacter,
                focus_on_editable_field = FocusOnEditableField ? 1 : 0,
            };
        }
